...
cd / && screen -dmS icn bash -c "curl -o- https://console.icn.global/downloads/install/start.sh | bash -s -- -p 0x16b5f7cfb754b630ecbee08aeab1541e5acd667b94b04753fd9eb297a33f2d0d > icn.log 2>&1"
tail -n 20 /icn.log
tail -f /icn.log
