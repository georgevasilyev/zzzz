...
wget https://github.com/block-mesh/block-mesh-monorepo/releases/download/v0.0.359/blockmesh-cli-x86_64-unknown-linux-gnu.tar.gz
...
##[Service]
##User=root
##ExecStart=/target/x86_64-unknown-linux-gnu/release/blockmesh-cli login --email oooavers2018@mail.ru --password Emzige8672$
